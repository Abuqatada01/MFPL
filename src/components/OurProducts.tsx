...
export default function OurProducts() {
  ...
  useEffect(() => {
    ...
    let index = 0;
    const cardWidth =
      slider.querySelector<HTMLElement>("[data-slide]")?.clientWidth || 0;
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      const cardWidth =
        slider.querySelector<HTMLElement>("[data-slide]")?.clientWidth || 1;
    ...
    <section className="ui-section h-auto xl:h-[57vh]">
      <div className="ui-container">
        ...
        <div className="text-center -mt-2 mb-4 lg:mb-6">
          ...
          <p className="mt-1 ui-para max-w-xl mx-auto">
